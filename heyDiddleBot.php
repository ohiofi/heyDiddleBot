...
$tweet1 = "Hey ".$rhymeSet1[0]." ".$rhymeSet1[0].", the ".$animal[0]." & the ".$rhymeSet1[1].", the ".$animal[1]." jumped over the ".$rhymeSet2[0].".";
$tweet2 = "The ".$adj[0]." ".$animal[2]." ".$synonymsForLaughed[0].", to see such ".$synonymsForFun[0]." & the ".$animal[3]." ran away with the ".$rhymeSet2[1].".";

// sleep for 20 seconds
sleep(20);
if(strlen($tweet1) > 140)// If tweet is already too long, shorten it.
  $tweet1 = substr($tweet1, 0, 140);
